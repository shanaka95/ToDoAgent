...
def create_app() -> FastAPI:
    ...
    This function creates the app with proper dependency injection
    and configuration.
    """
    # Get settings for app creation
    app_settings = get_app_settings()
...
if __name__ == "__main__":
    # Get settings for server startup
    app_settings = get_app_settings()
    uvicorn.run(app, host="0.0.0.0", port=int(app_settings.port))
